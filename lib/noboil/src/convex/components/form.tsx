...
type StringArrayValue = readonly string[] | string[] | undefined
interface TypedFields<T> {
  Arr: (p: WithName<Props<'Arr'>, Key<T, StringArrayValue>>) => ReactNode
  ...
  Files: (p: WithName<Props<'Files'>, Key<T, StringArrayValue>>) => ReactNode
  MultiSelect: (p: WithName<Props<'MultiSelect'>, Key<T, StringArrayValue>>) => ReactNode
