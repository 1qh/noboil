/** Convert an ArrayBuffer to base64 string (chunked to avoid stack overflow on large buffers). */
...
/** Browser-only: trigger a save-as dialog for a Blob with the given filename. */
