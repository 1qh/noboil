...
noboil ships **53 generators** that own **52 marker blocks** across 7 doc files. Every block is rebuilt from source on `bun docs` and CI fails on drift via `bun docs:check`.
...
| `lib/noboil/README.md` | `PACKAGE-INFO`, `TEST-COUNTS`, `DEMO-COUNT`, `HOTKEYS`, `CLI-TABLE-TYPES`, `FACTORY-TABLE`, `DEMO-TREE` |
| `/Users/o/noboil/noboil-doc/architecture.md` | `PORT-TABLE` |
| `/Users/o/noboil/noboil-doc/testing.md` | `TEST-COUNTS` |
