...
Coverage of public exports (every name reachable through `noboil/...` subpaths) by mention in `doc/content/docs/*.mdx`. **502/508 mentioned (99%).**

Undocumented (first 6 of 6):

`ANSI_RE`, `bold`, `cyan`, `dim`, `green`, `stripAnsi`
