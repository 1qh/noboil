...
Scanned **351 files**, **7652 declared symbols**. No `@beta`/`@alpha`/`@experimental`/`@deprecated`/`@internal` JSDoc tags found — entire public surface is **stable**.
...
Coverage of public exports (every name reachable through `noboil/...` subpaths) by mention in `doc/content/docs/*.mdx`. **490/493 mentioned (99%).**

Undocumented (first 3 of 3):

`isSourceTs`, `listTypeScriptFiles`, `walkFiles`
