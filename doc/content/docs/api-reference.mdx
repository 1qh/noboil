...
**43 subpath exports** from `noboil` package.json. Use exact import paths for tree-shaking.
...
Coverage of public exports (every name reachable through `noboil/...` subpaths) by mention in `doc/content/docs/*.mdx`. **497/500 mentioned (99%).**

Undocumented (first 3 of 3):

`findProjectRoot`, `parseEnvFile`, `parseEnvLine`
