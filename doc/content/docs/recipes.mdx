...
### `AuditExports` — `lib/noboil/src/convex/server/audit.ts`
...
### `CrudOptions` — `lib/noboil/src/convex/server/types.ts`
...
### `FileUploadExports` — `lib/noboil/src/spacetimedb/server/types/file.ts`
...
### `OrgCrudExports` — `lib/noboil/src/spacetimedb/server/types/org-crud.ts`
...
### `SetupConfig` — `lib/noboil/src/convex/server/types.ts`
