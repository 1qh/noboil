...
| --------------------------------------- | ---------------- | ----------- | ----------- |
| owned CRUD                              | `crud.ts`        | ✓ (438 loc) | ✓ (138 loc) |
| org-scoped CRUD                         | `org-crud.ts`    | ✓ (492 loc) | ✓ (399 loc) |
| child CRUD                              | `child.ts`       | ✓ (269 loc) | ✓ (163 loc) |
| singleton (1-per-user)                  | `singleton.ts`   | ✓ (75 loc)  | ✓ (112 loc) |
| cache (TTL + refresh)                   | `cache-crud.ts`  | ✓ (251 loc) | ✓ (172 loc) |
| log (append-only)                       | `log.ts`         | ✓ (396 loc) | ✓ (255 loc) |
| kv (string-keyed)                       | `kv.ts`          | ✓ (169 loc) | ✓ (147 loc) |
| quota (sliding window)                  | `quota.ts`       | ✓ (116 loc) | ✓ (109 loc) |
