...
| ----------- | ------------------ | ------------------- | ---------------- | -------- | --------------- |
| `base`      | 252 / 175          | 91 / 87             | 18 / 25          | 236L     | 4 / 4 ✓         |
| `child`     | 276 / 165          | 43 / 41             | 13 / 27          | 240L     | 4 / 4 ✓         |
| `kv`        | 170 / 163          | 43 / 49             | 10 / 23          | 270L     | 4 / 4 ✓         |
| `log`       | 398 / 276          | 77 / 78             | 12 / 17          | 357L     | 5 / 5 ✓         |
| `orgScoped` | 493 / 402          | 43 / 41             | 38 / 47          | 255L     | 4 / 4 ✓         |
| `owned`     | 441 / 141          | 43 / 41             | 54 / 57          | 266L     | 5 / 5 ✓         |
...
| ------- | ----------------- | -------------------- | --------------------- | ------ |
| `blog`  | 8/8 ✓             | 52 / 52 ✓            | 882 / 951 ✓           | 🟢     |
| `chat`  | 5/5 ✓             | 26 / 26 ✓            | 489 / 414 ✓           | 🟢     |
| `movie` | 2/2 ✓             | 14 / 14 ✓            | 303 / 526 ✓           | 🟢     |
| `org`   | 18/18 ✓           | 128 / 128 ✓          | 2368 / 2628 ✓         | 🟢     |
| `poll`  | 6/7 ✓             | 82 / 82 ✓            | 853 / 891 ✓           | 🟢     |
...
| `error-boundary.tsx`   | ✓ 12L  | ✓ 12L  | 1              | —        | —                                            | 🟢     |
| `fields.tsx`           | ✓ 24L  | ✓ 31L  | 5              | —        | —                                            | 🟢     |
| `file-field.tsx`       | ✓ 244L | ✓ 390L | 3              | —        | `FileApi`, `UploadOptions`, `UploadResponse` | 🟡     |
| `form.tsx`             | ✓ 169L | ✓ 196L | 7              | —        | —                                            | 🟢     |
| `index.ts`             | ✓ 11L  | ✓ 12L  | 21             | —        | `UploadOptions`, `UploadResponse`            | 🟡     |
| `misc.tsx`             | ✓ 12L  | ✓ 16L  | 3              | —        | —                                            | 🟢     |
| `permission-guard.tsx` | ✓ 25L  | ✓ 25L  | 1              | —        | —                                            | 🟢     |
| `step-form.tsx`        | ✓ 77L  | ✓ 83L  | 1              | —        | —                                            | 🟢     |
