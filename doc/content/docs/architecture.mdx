...
**244 shared files · 85 cvx-only · 60 stdb-only · 1 files with cross-backend symbol divergence.** Status: 🔴 68 unaccounted-for gap(s).

| Pair                     | shared    | cvx-only            | stdb-only           | symbol gaps | status |
| ------------------------ | --------: | ------------------- | ------------------- | ----------: | ------ |
| **lib/noboil/src**       | 84        | 46 (42 unaccounted) | 47 (25 unaccounted) | 1           | 🔴     |
...
- **lib/noboil/src**: cvx-only file `tools/caller-runtime.ts`, `tools/define-provider.ts`, `tools/prompt-blocks.ts`, `tools/http.ts`, `tools/validate.ts`, `tools/builder.ts`, `tools/parser.ts`, `tools/codegen/schema.ts`, `tools/codegen/emit.ts`, `tools/codegen/scan.ts`, `tools/codegen/extract-meta.ts`, `tools/codegen/index.ts`, `tools/types.ts`, `tools/__tests__/dispatch.test.ts`, `tools/__tests__/manifest.test.ts`, `tools/__tests__/parser.test.ts`, `tools/__tests__/boundary.test.ts`, `tools/__tests__/step-sink.test.ts`, `tools/__tests__/to-dispatch-error.test.ts`, `tools/__tests__/error.test.ts`, `tools/manifest.ts`, `tools/hermetic.ts`, `tools/index.ts`, `tools/error.ts`, `server/__tests__/setup-hooks.test.ts`, `server/__tests__/test-harness.test.ts`, `server/budget.ts`, `server/test-harness.ts`, `server/audit.ts`, `__tests__/manifest.test.ts`, `__tests__/budget.property.test.ts`, `__tests__/audit.test.ts`, `__tests__/budget.test.ts`, `__tests__/use-list.test.tsx`, `__tests__/budget.synthetic.test.ts`, `__tests__/use-mutate.test.ts`, `__tests__/use-bulk-mutate.test.tsx`, `__tests__/eslint-smoke.test.ts`, `__tests__/optimistic-store.test.tsx`, `__tests__/devtools.test.ts`, `__tests__/builder.test.ts`, `__tests__/use-form.test.tsx`
- **lib/noboil/src**: stdb-only file `server/__tests__/org.test.ts`, `server/__tests__/singleton.test.ts`, `server/__tests__/org-invites.test.ts`, `server/__tests__/child.test.ts`, `server/__tests__/org-members.test.ts`, `server/__tests__/cache-crud.test.ts`, `server/__tests__/org-crud.test.ts`, `server/__tests__/log.test.ts`, `server/__tests__/file.test.ts`, `server/__tests__/test.test.ts`, `server/__tests__/stdb-tables.test.ts`, `server/__tests__/presence.test.ts`, `server/__tests__/kv.test.ts`, `server/__tests__/quota.test.ts`, `server/__tests__/crud.test.ts`, `server/__tests__/setup.test.ts`, `server/__tests__/rls.test.ts`, `server/__tests__/org-join.test.ts`, `__tests__/migrate.test.ts`, `__tests__/check.test.ts`, `react/__tests__/use-list.test.tsx`, `react/__tests__/use-mutate.test.ts`, `react/__tests__/use-bulk-mutate.test.tsx`, `react/__tests__/optimistic-store.test.tsx`, `react/__tests__/devtools.test.ts`
