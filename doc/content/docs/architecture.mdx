...
**244 shared files · 85 cvx-only · 61 stdb-only · 1 files with cross-backend symbol divergence.** Status: 🔴 69 unaccounted-for gap(s).

| Pair                     | shared    | cvx-only            | stdb-only           | symbol gaps | status |
| ------------------------ | --------: | ------------------- | ------------------- | ----------: | ------ |
| **lib/noboil/src**       | 84        | 46 (42 unaccounted) | 48 (26 unaccounted) | 1           | 🔴     |
