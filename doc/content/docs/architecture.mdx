...
| ----------- | ------------------ | ------------------- | ---------------- | -------- | --------------- |
| `base`      | 251 / 175          | 90 / 85             | 18 / 25          | 236L     | 4 / 4 ✓         |
| `child`     | 274 / 165          | 43 / 41             | 13 / 27          | 240L     | 4 / 4 ✓         |
| `kv`        | 168 / 163          | 43 / 49             | 10 / 23          | 270L     | 4 / 4 ✓         |
| `log`       | 392 / 274          | 77 / 78             | 12 / 17          | 357L     | 5 / 5 ✓         |
| `orgScoped` | 498 / 401          | 43 / 41             | 38 / 47          | 255L     | 4 / 4 ✓         |
| `owned`     | 438 / 141          | 43 / 41             | 54 / 57          | 266L     | 5 / 5 ✓         |
| `quota`     | 116 / 125          | 36 / 80             | 14 / 15          | 257L     | 4 / 4 ✓         |
...
| ------- | ----------------- | -------------------- | --------------------- | ------ |
| `blog`  | 8/8 ✓             | 52 / 52 ✓            | 879 / 943 ✓           | 🟢     |
| `chat`  | 5/5 ✓             | 26 / 26 ✓            | 495 / 410 ✓           | 🟢     |
| `movie` | 2/2 ✓             | 14 / 14 ✓            | 299 / 519 ✓           | 🟢     |
| `org`   | 18/18 ✓           | 128 / 128 ✓          | 2364 / 2609 ✓         | 🟢     |
...
| `file-field.tsx`       | ✓ 239L | ✓ 391L | 3              | —        | `FileApi`, `UploadOptions`, `UploadResponse` | 🟡     |
| `form.tsx`             | ✓ 167L | ✓ 193L | 7              | —        | —                                            | 🟢     |
