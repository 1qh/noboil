...
const SidebarContext = React.createContext<null | SidebarContextProps>(null),
  ...
  SidebarGroupLabel = ({ asChild, className, ...props }: React.ComponentProps<'div'> & { asChild?: boolean }) => {
  ...
  SidebarGroupAction = ({ asChild, className, ...props }: React.ComponentProps<'button'> & { asChild?: boolean }) => {
