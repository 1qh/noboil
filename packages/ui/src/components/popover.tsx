...
const Popover = ({ ...props }: React.ComponentProps<typeof PopoverPrimitive.Root>) => (
  ...
  PopoverHeader = ({ className, ...props }: React.ComponentProps<'div'>) => (
    <div className={cn('flex flex-col gap-1 text-sm', className)} data-slot='popover-header' {...props} />
  ),
  PopoverTitle = ({ className, ...props }: React.ComponentProps<'h2'>) => (
    <div className={cn('font-medium', className)} data-slot='popover-title' {...props} />
  ),
  PopoverDescription = ({ className, ...props }: React.ComponentProps<'p'>) => (
