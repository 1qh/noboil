...
export const AgentHeader = memo(({ className, model, name, ...props }: AgentHeaderProps) => (
...
export const AgentInstructions = memo(({ children, className, ...props }: AgentInstructionsProps) => (
