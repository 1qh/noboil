...
export const TestResultsHeader = ({ children, className, ...props }: TestResultsHeaderProps) => (
...
export const TestResultsSummary = ({ children, className, ...props }: TestResultsSummaryProps) => {
...
export const TestResultsDuration = ({ children, className, ...props }: TestResultsDurationProps) => {
  const { summary } = use(TestResultsContext)
...
export const TestResultsProgress = ({ children, className, ...props }: TestResultsProgressProps) => {
  const { summary } = use(TestResultsContext)

  if (!summary) return null

  const passedPercent = (summary.passed / summary.total) * 100,
    failedPercent = (summary.failed / summary.total) * 100
...
export const TestResultsContent = ({ children, className, ...props }: TestResultsContentProps) => (
...
export const TestSuite = ({ children, className, name, status, ...props }: TestSuiteProps) => (
  <TestSuiteContext value={{ name, status }}>
...
export const TestSuiteName = ({ children, className, ...props }: TestSuiteNameProps) => {
...
export const TestSuiteContent = ({ children, className, ...props }: TestSuiteContentProps) => (
...
export const Test = ({ children, className, duration, name, status, ...props }: TestProps) => (
  <TestContext value={{ duration, name, status }}>
...
const statusStyles: Record<TestStatus, string> = {
  ...
  statusIcons: Record<TestStatus, React.ReactNode> = {
  ...
  TestStatusIcon = ({ status }: { status: TestStatus }) => (
...
export const TestStatus = ({ children, className, ...props }: TestStatusProps) => {
...
export const TestName = ({ children, className, ...props }: TestNameProps) => {
...
export const TestDuration = ({ children, className, ...props }: TestDurationProps) => {
...
export const TestError = ({ children, className, ...props }: TestErrorProps) => (
...
export const TestErrorMessage = ({ children, className, ...props }: TestErrorMessageProps) => (
...
export const TestErrorStack = ({ children, className, ...props }: TestErrorStackProps) => (
...
export const TestResults = ({ children, className, summary, ...props }: TestResultsProps) => (
  <TestResultsContext value={{ summary }}>
