...
const Avatar = ({
  ...
  AvatarBadge = ({ className, ...props }: React.ComponentProps<'span'>) => (
    <span
      className={cn(
  ...
  AvatarGroup = ({ className, ...props }: React.ComponentProps<'div'>) => (
    <div
      className={cn(
  ...
  AvatarGroupCount = ({ className, ...props }: React.ComponentProps<'div'>) => (
    <div
      className={cn(
