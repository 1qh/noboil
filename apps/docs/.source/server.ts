...
export const docs = await create.docs(
  ...
  {
    'api-reference.mdx': __fd_glob_1,
    'custom-queries.mdx': __fd_glob_2,
    'data-fetching.mdx': __fd_glob_3,
    'deployment.mdx': __fd_glob_4,
    'ejecting.mdx': __fd_glob_5,
    'forms.mdx': __fd_glob_6,
    'index.mdx': __fd_glob_7,
    'migration.mdx': __fd_glob_8,
    'native-apps.mdx': __fd_glob_9,
    'organizations.mdx': __fd_glob_10,
    'quickstart.mdx': __fd_glob_11,
    'recipes.mdx': __fd_glob_12,
    'schema-evolution.mdx': __fd_glob_13,
    'security.mdx': __fd_glob_14,
    'testing.mdx': __fd_glob_15
  }
)
